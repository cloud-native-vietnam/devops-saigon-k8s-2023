...
var log = function(message) {
  console.log(`v=${version} | Host: ${host} | ${message} | App Uptime: ${timeDelta(startTime)} seconds | Log Time: ${new Date()}`);
}

// handlers
var handleDefault = function(_req, res) {
  respond(res, 200, `Hello DevOps Saigon! 👋 | Host: ${host} | v=${version}`);
